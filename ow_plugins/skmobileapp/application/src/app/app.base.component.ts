...
export abstract class BaseApp {
    ...
    public static readonly HTTP_ERROR_FORBIDDEN_SUBSCRIBE: string = 'subscribe';
         ...
         switch (error.code) {
            ...
            case BaseApp.HTTP_ERROR_FORBIDDEN: // 403
                switch (error.type) {
                    ...
                    case BaseApp.HTTP_ERROR_FORBIDDEN_SUBSCRIBE :
                        if (this.payments.isPaymentsAvailable()) {
                            this.ionicApp.getRootNav().setRoot(InitialPaymentsPage, {
