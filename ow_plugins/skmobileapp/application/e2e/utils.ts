...
export class Utils {
     ...
     */
    async fillInputByPlaceholder(placeholder: string, value: string): Promise<any> {
     ...
     */
    async fillInputByCssClass(cssClass: string, value: string): Promise<any> {
     ...
     * Move element
     */
    moveElement(cssClass: string, positions: Array<{x: number, y: number}>,  index: number = 0): webdriverPromise.Promise<any> {
